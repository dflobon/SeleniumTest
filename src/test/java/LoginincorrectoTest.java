...
public class LoginincorrectoTest {
  ...
  public void loginincorrecto() {
    ...
    driver.manage().window().setSize(new Dimension(1352, 1440));
    driver.findElement(By.cssSelector("*[data-test=\"username\"]")).click();
    driver.findElement(By.cssSelector("*[data-test=\"username\"]")).sendKeys("hola");
    driver.findElement(By.cssSelector("*[data-test=\"password\"]")).click();
    driver.findElement(By.cssSelector("*[data-test=\"password\"]")).sendKeys("adios");
